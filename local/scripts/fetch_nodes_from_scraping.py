...
if not all([NEO4J_URI, NEO4J_USER, NEO4J_PASSWORD, API_KEY, USER_AGENT, NODES_URL]):
    raise EnvironmentError("Neo4j connection details are missing! Please check the .env file.")
