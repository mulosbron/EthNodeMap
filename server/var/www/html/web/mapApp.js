document.addEventListener('DOMContentLoaded', function () {
    ...
    async function fetchStatistics() {
        try {
            const osResponse = await fetch('https://api.eth-node-map.xyz/get-statistics/os');
            const osData = await osResponse.json();
            updateStatisticsTable('os-statistics', osData.os);

            const clientResponse = await fetch('https://api.eth-node-map.xyz/get-statistics/client');
            const clientData = await clientResponse.json();
            updateStatisticsTable('client-statistics', clientData.client);

            const ispResponse = await fetch('https://api.eth-node-map.xyz/get-statistics/isp');
            const ispData = await ispResponse.json();
            updateStatisticsTable('isp-statistics', ispData.isp);

            const countryResponse = await fetch('https://api.eth-node-map.xyz/get-statistics/country');
