document.addEventListener('DOMContentLoaded', function () {
    ...
    async function fetchAndPopulateData() {
        try {
            const response = await fetch('https://api.eth-node-map.xyz/nodes');
    ...
    async function fetchFilters() {
        try {
            let response = await fetch('https://api.eth-node-map.xyz/nodes/os-types');
            ...
            response = await fetch('https://api.eth-node-map.xyz/nodes/isps');
            ...
            response = await fetch('https://api.eth-node-map.xyz/nodes/client-types');
            data = await response.json();
            ...
            response = await fetch('https://api.eth-node-map.xyz/nodes/countries');
            data = await response.json();
    ...
    async function fetchDynamicData() {
        try {
            const response = await fetch('https://api.eth-node-map.xyz/nodes/count');
            const data = await response.json();
    ...
    async function fetchLatestNodes() {
        try {
            const response = await fetch('https://api.eth-node-map.xyz/nodes/latest');
            const data = await response.json();
    ...
    async function fetchStatistics() {
        try {
            const osResponse = await fetch('https://api.eth-node-map.xyz/statistics/os');
            const osData = await osResponse.json();
            updateStatisticsTable('os-statistics', osData.os);

            const clientResponse = await fetch('https://api.eth-node-map.xyz/statistics/client');
            const clientData = await clientResponse.json();
            updateStatisticsTable('client-statistics', clientData.client);

            const ispResponse = await fetch('https://api.eth-node-map.xyz/statistics/isp');
            const ispData = await ispResponse.json();
            updateStatisticsTable('isp-statistics', ispData.isp);

            const countryResponse = await fetch('https://api.eth-node-map.xyz/statistics/country');
